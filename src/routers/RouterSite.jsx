...
import GroupTaskDetail from "../components/frontend/group/details/groupmanager/GroupTaskDetail";
...
const RouterSite =[
  ...
  //group
    ...
    { path: "/nhom/:groupId/cong-viec/:taskId", element: <PrivateRoute element={<GroupTaskDetail/>} /> },
